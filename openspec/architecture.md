...
- fitness: `bun test` @ `test/fitness/fit-01..10-*.test.ts` (10 functions: commons-no-AST, dialect-leaf-rule, commons-bundle-budget, .d.ts semver gate, serializable-bytes, example-jsdoc, no-tree-in-core, no-kit-bleed, pkg-exports-resolution, engine-client-port-guard — the 10th cites `REQ-FIT-09` not `REQ-FIT-10`: `fit-09` was already claimed by pkg-exports-resolution/`REQ-PKG-01` before this function existed, so the file is `fit-10-*` but the REQ-ID stays `FIT-09`)
